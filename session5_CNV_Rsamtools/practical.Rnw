...
fasta=../session4_multi_sample_calling_annotation/human_g1k_v37.fasta
...
java -Xmx4g -jar picard/SamToFastq.jar INPUT=results/only_paired.bam \
            FASTQ=results/read1.fq SECOND_END_FASTQ=results/read2.fq
@ 
...
java -Xmx4g -jar picard/SamToFastq.jar INPUT=paired_fixed.bam FASTQ=results/read1.fq  \
            SECOND_END_FASTQ=results/read2.fq
@
...
###filename below
fileName=data/HG00123/alignment/HG00123.mapped.ILLUMINA.bwa.GBR.low_coverage.20120522.bam
...
samtools view -b $BAM 5:150200000-150225000 > results/HG00123.bam
samtools view results/HG00123.bam  | awk '{if (($9 > 15000) && ($9 < 25000)) print}' | less -S
@
...
library(Rsamtools)
which <- GRanges(seqnames=Rle("5"),
                 IRanges(start = 150200000, end = 150225000))
