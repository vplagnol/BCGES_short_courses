...
bin/pear-0.9.4-64 -e -v 10 \
   -f ../data/fastq_for_merging/reads1.fq -r ../data/fastq_for_merging/reads1.fq -o results/merged -c 40
@
...
samtools view results/BRCA1_HG00118.bam 17:43124115-43124017  > results/BRCA1_exon1.sam
@ 
